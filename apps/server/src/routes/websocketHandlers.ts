...
export const handleOpen = (ws: MyWebSocket) => {
  console.log(
  ...
  // ws.subscribe(roomId); // Not dealing with pub/sub manually here, RoomManager handles list
...
export const handleMessage = async (
  ...
  try {
    ...
    await dispatchMessage({ ws, message: parsedMessage });
  } catch (error) {
